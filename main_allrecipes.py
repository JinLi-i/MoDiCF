...
parser.add_argument("--lambda_rec", type=float, default=0.6, help="Reconstruction loss weight")

parser.add_argument("--layers", type=int, default=2, help="Number of layers")
parser.add_argument('--model_cat_rate', type=float, default=0.4, help='model_cat_rate')
parser.add_argument('--id_cat_rate', type=float, default=0.3, help='before GNNs')
...
parser.add_argument('--gnn_embed_size', type=int, default=128, help='Embedding size')
parser.add_argument('--isSparse', type=bool, default=True, help='isSparse')
parser.add_argument('--head_num', default=8, type=int, help='head_num_of_multihead_attention. For multi-model relation.')
...
parser.add_argument('--cl_rate', type=float, default=0.15, help='Control the effect of the contrastive auxiliary task')

parser.add_argument("--dataset", type=str, default="allrecipes", help="Dataset name")
...
parser.add_argument("--load_dir", type=str, default="./checkpoint/allrecipes/", help="Load directory")
...
parser.add_argument("--alpha", type=float, default=0.5, help="Item loss weight")
