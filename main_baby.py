...
parser.add_argument('--id_cat_rate', type=float, default=0.7, help='before GNNs')
...
parser.add_argument('--cl_rate', type=float, default=0.09, help='Control the effect of the contrastive auxiliary task')
...
parser.add_argument("--c", type=float, default=0.01, help="Counterfactual inference parameter")
parser.add_argument("--alpha", type=float, default=0.7, help="Item loss weight")
